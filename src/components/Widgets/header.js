    ...
    <HeaderAntd className="header">
      ...
      >
        <div className={`d-flex justify-content-center w-100 ${Features !== "LOGIN" ? 'header__container' : ''}`}>
          <Menu.Item className="header__logo" onClick={() => history.replace("/")}>{stationsLogo !== "" ? (<img src={stationsLogo} className="logo" alt="logo" />) : <img src={IconLogo} className="logo" alt="logo"/> }</Menu.Item>
